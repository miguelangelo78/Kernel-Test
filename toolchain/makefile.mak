...
LLVMCPPFLAGS = -ffreestanding -nostdlib -nodefaultlibs -finline-functions -target i686-pc-none-elf -Wno-format -pedantic -fno-omit-frame-pointer -Wall -Wextra -Wno-unused-function -Wno-unused-parameter -Wno-unknown-pragmas -std=c++11 -fno-exceptions -IC:\llvm\lib\clang\3.8.0\include -Isrc
CFLAGS = -T $(TOOLCH)\$(LINKER) -Itoolchain\Tools\Windows\Cross\i686-elf\lib\gcc\i686-elf\4.8.2\include -Isrc -g -finline-functions -ffreestanding -fbuiltin -Wall -Wextra
LLVMCFLAGS = -ffreestanding -nostdlib -nodefaultlibs -finline-functions -target i686-pc-none-elf -Wno-format -pedantic -fno-omit-frame-pointer -Wall -Wextra -Wno-unused-function -Wno-unused-parameter -Wno-unknown-pragmas -fno-exceptions -IC:\llvm\lib\clang\3.8.0\include -Isrc
ASFLAGS = 
NASFLAGS = -g -f elf32
