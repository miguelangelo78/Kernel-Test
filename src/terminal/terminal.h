...
class Terminal {
	public:
		...
		void putc_at(int x, int y, const char chr, uint32_t color);
		void putc_at(int x, int y, const char chr, uint32_t color, uint32_t bgcolor);
		void putc_at(int x, int y, const char chr);
		void puts(const char * str, uint32_t color);
		void puts(const char * str, uint32_t color, uint32_t bgcolor);
		void puts(const char * str);
		void puts_at(const char * str, int x, int y);
		void puts_at(const char * str, int x, int y, uint32_t color);
		void puts_at(const char * str, int x, int y, uint32_t color, uint32_t bgcolor);
		...
		void printf_at(int x, int y, uint32_t color, const char *fmt, ...);
		void printf_at(int x, int y, uint32_t color, const char *fmt, va_list args);
		void printf_at(int x, int y, const char *fmt, ...);
		void printf_at(int x, int y, const char *fmt, va_list args, char ign);
